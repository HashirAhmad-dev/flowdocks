...
- **Pin folders, drives and files** — drag one from a file manager, or use
  **Pin a folder / Pin a file** in the dock menu. A folder or drive opens in the
  file manager, a file in its default app; a pinned drive drops out while it is
  unmounted and returns when it is back.
